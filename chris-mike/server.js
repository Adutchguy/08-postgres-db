...
app.get('/new', function(request, response) {
  ...
  // 1, 2, 5
  //
  //Article.truncateTable, Article.prototype.insertRecord, Article.prototype.deleteRecord, Article.prototype.updateRecord,
  //
  // C, U
...
// Creates the articles table and then runs loadAticles.
loadDB();
